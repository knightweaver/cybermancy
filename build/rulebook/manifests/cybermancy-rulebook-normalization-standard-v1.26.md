# Cybermancy Rulebook Normalization Standard v1.26
...
**Frozen repository baseline:** `fe26117617230255338a333830907f4f80d3ecab`  
...
1. `cybermancy-rulebook-publication-manifest-v1.26.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.26.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `fe26117617230255338a333830907f4f80d3ecab`.
