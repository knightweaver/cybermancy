# Cybermancy Rulebook Normalization Standard v1.25
...
**Frozen repository baseline:** `07ceff763844a5a82404392f56896256be6419b9`  
...
1. `cybermancy-rulebook-publication-manifest-v1.25.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.25.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `07ceff763844a5a82404392f56896256be6419b9`.
...
| Structured logical entities | 1083 |
...
|---|---|---:|---|---|
| `adversaries` | `src/packs/adventures/adversaries` | 106 | gm | tier, classification, name |
...
- logical entity counts reconcile to 1083;
