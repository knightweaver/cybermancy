# Cybermancy Rulebook Normalization Standard v1.28
...
**Frozen repository baseline:** `db893e26bf3791ed5f716a19ab80aa420e179c03`  
...
1. `cybermancy-rulebook-publication-manifest-v1.28.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.28.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `db893e26bf3791ed5f716a19ab80aa420e179c03`.
