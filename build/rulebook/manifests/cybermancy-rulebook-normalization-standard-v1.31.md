# Cybermancy Rulebook Normalization Standard v1.31
...
**Frozen repository baseline:** `2c0fe6452f3984c8d7ff6eb552314e3c62c15b8a`  
...
1. `cybermancy-rulebook-publication-manifest-v1.31.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.31.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `2c0fe6452f3984c8d7ff6eb552314e3c62c15b8a`.
