# Cybermancy Rulebook Assembly Manifest v1.32

**Status:** NORMATIVE  
**Step:** Rulebook Step 3 — Book Information Architecture  
**Parent authority:** `cybermancy-rulebook-publication-manifest-v1.32.json`  
**Frozen repository commit:** `046b141321d1f9513d9fcf88477cca089241b3a0`  
**Supersedes:** `cybermancy-rulebook-assembly-manifest-v1.31.json`
...
- **1085 logical structured entities**
...
| B009 | `domains` | `src/packs/system/domains` | 74 | player | ch14-domains |
...
**Total logical structured entities: 1085.**
...
- structured-family counts sum to 1085;
