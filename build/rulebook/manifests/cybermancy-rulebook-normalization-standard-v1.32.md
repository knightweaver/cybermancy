# Cybermancy Rulebook Normalization Standard v1.32
...
**Frozen repository baseline:** `046b141321d1f9513d9fcf88477cca089241b3a0`  
...
1. `cybermancy-rulebook-publication-manifest-v1.32.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.32.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `046b141321d1f9513d9fcf88477cca089241b3a0`.
...
| Structured logical entities | 1085 |
...
| `domains` | `src/packs/system/domains` | 74 | player | source-folder, level-or-tier, name |
...
- logical entity counts reconcile to 1085;
