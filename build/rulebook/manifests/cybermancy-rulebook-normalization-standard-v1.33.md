# Cybermancy Rulebook Normalization Standard v1.33
...
**Frozen repository baseline:** `e4f4b107625e31cb02b34991d5e68fc21a24a7f6`  
...
1. `cybermancy-rulebook-publication-manifest-v1.33.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.33.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `e4f4b107625e31cb02b34991d5e68fc21a24a7f6`.
