# Cybermancy Rulebook Normalization Standard v1.27
...
**Frozen repository baseline:** `37ab78eba9cffd30ee287ea5001a79a184ab4490`  
...
1. `cybermancy-rulebook-publication-manifest-v1.27.json` — Step 2 source authority and publication scope.
2. `cybermancy-rulebook-assembly-manifest-v1.27.json` — Step 3 book topology, ordering, audience, placement, selectors, profiles, and structured-family placement.
3. Canonical repository content at commit `37ab78eba9cffd30ee287ea5001a79a184ab4490`.
