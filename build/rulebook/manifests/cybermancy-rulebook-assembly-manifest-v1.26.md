# Cybermancy Rulebook Assembly Manifest v1.26

**Status:** NORMATIVE  
**Step:** Rulebook Step 3 — Book Information Architecture  
**Parent authority:** `cybermancy-rulebook-publication-manifest-v1.26.json`  
**Frozen repository commit:** `fe26117617230255338a333830907f4f80d3ecab`  
**Supersedes:** `cybermancy-rulebook-assembly-manifest-v1.25.json`
