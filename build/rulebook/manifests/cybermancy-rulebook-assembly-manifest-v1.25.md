# Cybermancy Rulebook Assembly Manifest v1.25

**Status:** NORMATIVE  
**Step:** Rulebook Step 3 — Book Information Architecture  
**Parent authority:** `cybermancy-rulebook-publication-manifest-v1.25.json`  
**Frozen repository commit:** `07ceff763844a5a82404392f56896256be6419b9`  
**Supersedes:** `cybermancy-rulebook-assembly-manifest-v1.24.json`
...
- **1083 logical structured entities**
...
|---|---|---|---:|---|---|
| B001 | `adversaries` | `src/packs/adventures/adversaries` | 106 | gm | ch30-adversaries |
...
**Total logical structured entities: 1083.**
...
- structured-family counts sum to 1083;
