...
class TestManifestIntegration(unittest.TestCase):
    ...
    def test_manifest_join_detects_swapped_authored_input(self):
        ...
        pub={'repository':{'gitCommit':'X'},'publicationInputs':{'authoredDocuments':[{'path':'a.md','disposition':'INCLUDE','decisionStatus':'DECIDED'}],'structuredFamilies':[{'generatorFamily':'things','entityCount':1,'disposition':'INCLUDE','decisionStatus':'DECIDED'}]}}
    ...
    def _docs(self, divider_refs=None, opener_refs=None):
        ...
        pub={
            ...
            'publicationInputs':{
                ...
                'structuredFamilies':[{'generatorFamily':'things','entityCount':1,'disposition':'INCLUDE','decisionStatus':'DECIDED'}]
            }
        }
        asm={
