...
<img src="../../../assets/icons/features/become-one-with-the-matrix.webp" alt="Become one with the Matrix" class="item-image" style="width:300px; height:auto;">
## Description
...
Tick down the die by 1 for each Action you take.*</div>
...
<br>
**UUID:** `Compendium.cybermancy.system.become-one-with-the-matrix`
</div>
</div>
