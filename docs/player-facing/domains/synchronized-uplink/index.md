...
<img src="../../assets/icons/domains/synchronized-uplink.webp" alt="Synchronized Uplink" class="item-image">

# Synchronized Uplink Domain
...
**Source:** *(fill in)* • **UUID:** `Compendium.cybermancy.system.synchronized-uplink`
</div>
</div>
