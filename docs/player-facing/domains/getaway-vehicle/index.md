...
<img src="../../assets/icons/domains/getaway-vehicle.webp" alt="Getaway Vehicle" class="item-image">

# Getaway Vehicle Domain
...
**Source:** *(fill in)* • **UUID:** `Compendium.cybermancy.system.getaway-vehicle`
</div>
</div>
