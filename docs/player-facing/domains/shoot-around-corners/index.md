<div class="domain" markdown="1">
    <img src="../../assets/icons/domains/shoot-around-corners.webp" alt="Shoot Around Corners" class="item-image">
    ...
    **UUID:** `Compendium.cybermancy.system.shoot-around-corners`
    </div>
    </div>
