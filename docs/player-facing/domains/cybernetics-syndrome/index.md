<div class="domain" markdown="1">
    <img src="../../assets/icons/domains/cybernetics-syndrome.webp" alt="Cybernetics syndrome" class="item-image">
    ...
    **UUID:** `Compendium.cybermancy.system.cybernetics-syndrome`
    </div>
    </div>
