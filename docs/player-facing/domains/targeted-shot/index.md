...
<img src="../../assets/icons/domains/targeted-shot.webp" alt="Targeted Shot" class="item-image">

# Targeted Shot Domain
...
**Source:** *(fill in)* • **UUID:** `Compendium.cybermancy.system.targeted-shot`
</div>
</div>
