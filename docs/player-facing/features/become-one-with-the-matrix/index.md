...
<img src="../../assets/icons/features/become-one-with-the-matrix.webp" alt="Become one with the Matrix" class="item-image">
...
**Source:** *(fill in)* • **UUID:** `Compendium.cybermancy.system.become-one-with-the-matrix`
</div>
</div>
