...
**Status:** Absorbed into the Council, disguised as a “regulatory oversight consortium.”
**Legacy function:** Custodians of the original Prometheus architecture.
...
**Status:** Cabal-aligned extremist technomancers.
**Legacy function:** Seekers of Prometheus’ consciousness.
...
**Status:** Semi-public; operates as a research contractor to multiple megacorps.
**Legacy function:** Exploiting Promethean fragments for profit.
...
**Status:** Small, decentralized techno-ascetic order; neither Council nor Cabal.
**Legacy function:** Guardians of memory.
...
**Status:** Rumor; possibly myth.
**Legacy function:** Self-propagating code believed to be the last true piece of Prometheus.
